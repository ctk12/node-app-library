...
router
    .route("/")
    .post((0, auth_middleware_1.default)(), transaction_1.transactionController.alterCreateTransaction, (0, validate_1.validate)(transaction_1.transactionValidation.createTransactions), transaction_1.transactionController.createTransaction)
...
router
    ...
    .patch((0, auth_middleware_1.default)(), 
// transactionController.alterCreateTransaction,
(0, validate_1.validate)(transaction_1.transactionValidation.updateTransaction), transaction_1.transactionController.updateTransaction)
