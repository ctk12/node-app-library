...
const passport_1 = __importDefault(require("./modules/auth/passport"));
...
const addMulter = (0, multer_1.default)();
...
passport_2.default.use("jwt", passport_1.default);
// Routes
app.use("/api", addMulter.fields([]), routes_1.default);
